...
![Smoothed Stock Ex](.\figures\smoothed_stock_ex.png)
...
- How many stocks do we buy sell?
...
$$
\begin{aligned}
{ f }^{ * }:\quad fraction\quad of\quad portfolio\quad to\quad wager
\end{aligned}
$$
$$
\begin{aligned}
p:probability of\quad winning
\end{aligned}
$$
$$
\begin{aligned}

...
Basically, we plugged our models into the Zipline.io framework by deriving from Zipline's `TradingAlgorithm` Python base class and implementing our own `_handle_data` functions. For more information, refer to the [Zipline documenation](http://www.zipline.io/beginner-tutorial.html).
